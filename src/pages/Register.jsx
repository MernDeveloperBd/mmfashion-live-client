                ...
                <div className='w-full justify-center items-center p-0 md:p-10 '>
                    <div className='grid grid-cols-1 md:grid-cols-2 md:w-[60%] w-full mx-auto bg-white rounded-md'>
                        <div className='px-8 py-8 w-full '>
                            ...
                            <div>
                                <form onSubmit={register} className='text-slate-600'>
                                    ...
                                    <div className='flex flex-col gap-1 mb-4'>
                                     ...
                                     <button className='px-8 w-full py-2 bg-[#149777] shadow-lg hover:shadow-indigo-500/30 text-white rounded-md'>Register</button>
                                </form>
                         ...
                         <div className='w-full h-full py-4 pr-4 md:block hidden'>
