...
const Shop = () => {
  ...
  }, [selectedCatName, selectedSubName, selectedChildName, state.values]);
  ...
  }, [imageFile, pageNumber, perPage, selectedCatId, selectedSubId, selectedChildId, state.values, rating, sortPrice]);
            ...
            <div className="w-full md:w-9/12 mt-4">
              <div className="pl-00 md:pl-4">
                <div className="py-2 bg-white mb-10 px-1.5 rounded-md flex justify-between items-center gap-1 border border-slate-200">
                  ...
                  Tip: Select category/sub/child to narrow results.
                </p> */}
                  </div>
