...
import { get_dashboard_index_data } from '../../store/Reducers/dashboardReducers'
...
const Index = () => {
    ...
    return (
        <div>
            <div className='grid md:grid-cols-3 grid-cols-1 gap-2 md:gap-5'>
                <div className='flex justify-center items-center p-5 bg-green-200 rounded-md gap-5'>
                ...
                <div className='flex justify-center items-center p-5 bg-gray-100 rounded-md gap-5'>
                ...
                <div className='flex justify-center items-center p-5 bg-red-100 rounded-md gap-5'>
                            ...
                            <tbody>
                                {
                                   recentOrders?.map((o, i) => <tr key={i} className='bg-white border-b'>
                                        ...
                                        <td scope='row' className='px-6 py-4 font-medium whitespace-nowrap'>TK {o.price}</td>
