    ...
    <div className='mt-8'>
       <div className='flex gap-10 md:flex-col'>
        <div className='flex flex-col gap-2 justify-start items-start py-4'>
          ...
          <p className='text-sm text-slate-600'>{150} Reviews</p>
        </div>
        <div className='flex gap-2 flex-col py-4'>
          <div className='flex justify-start items-center gap-5'>
            ...
            <div className='w-[200px] h-[14px] bg-slate-200 relative'>
              <div style={{ width: `${Math.floor((100 * (rating_review[0]?.sum || 0)) / 20)}%` }} className='h-full bg-[#EDBB0E]'></div>
            </div>
          ...
          <div className='flex justify-start items-center gap-5'>
            ...
            <div className='w-[200px] h-[14px] bg-slate-200 relative'>
              <div style={{ width: `${Math.floor((100 * (rating_review[1]?.sum || 0)) / 20)}%` }} className='h-full bg-[#EDBB0E]'></div>
            </div>
          ...
          <div className='flex justify-start items-center gap-5'>
            ...
            <div className='w-[200px] h-[14px] bg-slate-200 relative'>
              <div style={{ width: `${Math.floor((100 * (5?.sum || 0)) / 20)}%` }} className='h-full bg-[#EDBB0E]'></div>
            </div>
            <p className='text-sm text-slate-600 w-[0%]'>{3?.sum}</p>
          </div>
          <div className='flex justify-start items-center gap-5'>
            <div className='text-md flex gap-1 w-[93px]'>
              <RatingTemp rating={1} />
            ...
            <div className='w-[200px] h-[14px] bg-slate-200 relative'>
              <div style={{ width: `${Math.floor((100 * (4?.sum || 0)) / 20)}%` }} className='h-full bg-#EDBB0E]'></div>
            </div>
            <p className='text-sm text-slate-600 w-[0%]'>{4?.sum}</p>
          </div>
          <div className='flex justify-start items-center gap-5'>
            <div className='text-md flex gap-1 w-[93px]'>
              <RatingTemp rating={0} />
