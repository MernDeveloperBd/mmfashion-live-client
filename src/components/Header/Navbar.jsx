                            ...
                            <ul className="py-2 overflow-auto">
                                {categories?.map((cat, i) => (
                                    <li key={i} className="hover:bg-gray-100 dark:hover:bg-gray-600">
                                        <Link to={`/products?category=${cat?.name}`} className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 dark:text-gray-200">
                    ...
                    <div className="flex-1 w-full">
                        <div className="">
                            <div className="flex items-center bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded md:rounded-full shadow-sm focus-within:ring-2 focus-within:ring-brand-dark overflow-hidden">
                                ...
                                />
                                <button onClick={search} className="bg-brand-dark hover:bg-brand px-6 py-2 font-semibold transition-all duration-300 cursor-pointer hover:text-violet-600">
                                    Search
                                </button>
                            </div>
                        </div>
